                            ...
                            @if ($this->person->linkedin)
                                <div class="font-medium text-md leading-tight">
                                    <div class="flex items-center">
                                        ...
                                        <a href="https:://www.linkedin.com/in/{{ $this->person->linkedin ?? '-' }}"
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           title="{{ $this->person->linkedin ?? '-' }}"
                                           class="flex items-center justify-center md:justify-start text-secondary hover:underline"
                                        >
                                            {{ $this->person->linkedin ?? '-' }}
                                        </a>
                                    </div>
                                </div>
                            @endif
